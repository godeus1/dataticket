class CreateSolidQueueTables < ActiveRecord::Migration[8.1]
  def change
    # SolidQueue estava configurado para usar um banco separado (railway_queue)
    # que nunca foi provisionado. Movemos as tabelas para o banco principal.
    # Todos os create_table são idempotentes (if_not_exists: true).
    ...
    add_foreign_key :solid_queue_ready_executions, :solid_queue_jobs,
                    column: :job_id, on_delete: :cascade if !foreign_key_exists?(:solid_queue_ready_executions, :solid_queue_jobs)
    ...
    add_foreign_key :solid_queue_scheduled_executions, :solid_queue_jobs,
                    column: :job_id, on_delete: :cascade if !foreign_key_exists?(:solid_queue_scheduled_executions, :solid_queue_jobs)
    ...
    add_foreign_key :solid_queue_claimed_executions, :solid_queue_jobs,
                    column: :job_id, on_delete: :cascade if !foreign_key_exists?(:solid_queue_claimed_executions, :solid_queue_jobs)
    ...
    add_foreign_key :solid_queue_blocked_executions, :solid_queue_jobs,
                    column: :job_id, on_delete: :cascade if !foreign_key_exists?(:solid_queue_blocked_executions, :solid_queue_jobs)
    ...
    add_foreign_key :solid_queue_failed_executions, :solid_queue_jobs,
                    column: :job_id, on_delete: :cascade if !foreign_key_exists?(:solid_queue_failed_executions, :solid_queue_jobs)
    ...
    add_foreign_key :solid_queue_recurring_executions, :solid_queue_jobs,
                    column: :job_id, on_delete: :cascade if !foreign_key_exists?(:solid_queue_recurring_executions, :solid_queue_jobs)
  end
end
